...
if(empty($_GET['Id'])){
    ...
    if($resultado!=0){
        while($data=mysqli_fetch_array($query)){
            ...
            $p_tratamiento=$data['Plan_Tratamiento'];
            ...
            $option_h='<option value="'.$HC.'"select>'.$p_tratamiento.'</option>';  
...
<form class="formulario" action="modificar_Ma.php" method="POST">
        ...
        <div class="contenedor">
            ...
            <input tye="text" name="Consultorio" id="Consultorio" required value="<?php echo$consultorio?>">
            <label for="E">Estado Agenda</label>
            <input tye="text" name="EstadoA" id="EstadoA" required value="<?php echo$estado?>">
    ...
    <label for="HCe">Historia Clinica</label>
            <?php
