...
<body style="height:30px">
    ...
    <tr>
        ...
        <?php 
    //paginador
    $sql_register=mysqli_query($conexion,"SELECT COUNT(*) as total_registro from medico where Estado_Medico!='INACTIVO' ");
...
$total_paginas= ceil($total_registro / $x_pag);
         ...
         $resultado = mysqli_query($conexion,"SELECT * FROM medico WHERE Estado_Medico!='INACTIVO' order by Id_Medico LIMIT $desde,$x_pag");
    ...
    <th><a href="Modificar_M.php?id=<?php echo $data ["Id_Medico"];?>" class="button green" name="Modificar" >Modificar</a> 
        <a href="eliminarm.php?id=<?php echo $data ["Id_Medico"];?>" class="button red" name="Eliminar" >Eliminar</a>
    </th>
