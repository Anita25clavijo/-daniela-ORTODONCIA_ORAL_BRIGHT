...
<body>
    ...
    ?>
    <form action="buscar_U.php" method="GET" class="form_search">
...
<center><a href="agregarA.php"  class="button">Agregar</a></center>
<div class="paginador">
       <ul>
           <?php 
           if($pagina != 1){
