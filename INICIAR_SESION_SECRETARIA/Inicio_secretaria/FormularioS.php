...
<body>
    ...
    <form class="formulario" action="agregar_s.php" method="POST">
        ...
        <div class="contenedor">        
            ...
            <label for="Ep">Estado Secretaria:</label>
            <input type="text" name="Es" id="Es" required>
...
<footer style="margin-top:1070px;"> 
