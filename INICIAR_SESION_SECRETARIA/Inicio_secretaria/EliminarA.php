...
<body>
 ...
 <form method="POST" class="formulario">
 	<h2>¿Esta segura de eliminar la cita <?php echo $codigo; ?> ? </h2>
 	<input type="hidden" name="Id" value="<?php echo $codigo;?>">
 	<input type="submit"  value="aceptar" class="button" href="gestionarC.php">
 	<a href="gestionarC.php"><input type="button" value="Cancelar" class="button"></a>
 </form>
</body>
</html>