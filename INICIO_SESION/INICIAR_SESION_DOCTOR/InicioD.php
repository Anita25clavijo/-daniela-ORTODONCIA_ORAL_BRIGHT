...
<header>
            ...
            <ul class="menu"> 
             ...
             <li><a href="cerrar_sesion.php" style="padding-left:420px;padding-right:15px;">Doctor <?php echo $_SESSION['Usuario'] ?>  :    Login out  </a>
            </ul> 
        </nav>
    </header>
<img src="../../IMAGENES/medico-dibujos-animados-vacuna.jpg" width="300px" height="200px" alt="" class="item-img" style="
    width: 380px;
    height: 380px;
    margin-left: 500px;
    margin-top: 100px;
