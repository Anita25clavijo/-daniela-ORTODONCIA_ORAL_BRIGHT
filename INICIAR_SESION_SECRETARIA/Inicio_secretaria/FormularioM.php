...
<head>
	...
	<link rel="stylesheet" type="text/css" href="FomularioM.css">
    <link rel="stylesheet" href="FormularioM.css">
...
<body>
    ...
    <form class="formulario" action="agregar_m.php" method="POST">
	    ...
	    <div class="contenedor">	
            ...
            <input tye="text" name="Nb" id="Nb" required>
            <label for="Ap">Apellidos:</label>
            <input tye="text" name="Ap" id="Ap" required>
            ...
            <label for="Ep">Tarjeta Profesional:</label>
            <input tye="text" name="Tp" id="Tp" required>
            <label for="Ep">Especialidad:</label>
            <input tye="text" name="Es" id="Es" required>
            <label for="Ep">Estado Medico:</label>
            <input tye="text" name="Em" id="Em" required>
