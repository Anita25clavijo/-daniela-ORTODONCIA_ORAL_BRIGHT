...
if(empty($_GET['id']))
{
    ...
    $id=$_GET['id'];
    $query=mysqli_query($conexion,"SELECT*FROM paciente WHERE Id_Paciente='$id'");
...
<form class="formulario" action="Modificar_Pa.php" method="POST">
	    ...
	    <div class="contenedor">
			...
			<input type="date" name="Fecha" required max="2023-12-31" value="<?php echo$Fecha?>">
            <label for="E">Estado Paciente</label>
