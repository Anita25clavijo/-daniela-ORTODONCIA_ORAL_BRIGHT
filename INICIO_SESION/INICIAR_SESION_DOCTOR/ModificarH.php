...
<div class="contenedor"> 
            ...
            <input type="text" name="rediofrafia" id="decripcion" required value="<?php echo$i?>">
            <label for="Descripcion">Pronostico:</label>
            <input type="text" name="pronostico" id="decripcion" required value="<?php echo$pr?>">
            ...
            <input type="number" name="abono" id="presupuesto" placeholder="$000.000.000 " required value="<?php echo$nombre?>">
            <?php
            $query_historia=mysqli_query($conexion,"SELECT*FROM historia_clinica");
            $resultado=mysqli_num_rows($query_historia);
            ?>
