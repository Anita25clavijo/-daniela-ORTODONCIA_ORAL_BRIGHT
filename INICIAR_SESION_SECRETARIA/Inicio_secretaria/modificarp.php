...
<body style="height:30px">
    ...
    <tr>
        ...
        <?php 
    //paginador
    $sql_register=mysqli_query($conexion,"SELECT COUNT(*) as total_registro from paciente where Estado_Paciente!='INACTIVO' ");
...
$total_paginas= ceil($total_registro / $x_pag);
         ...
         $resultado = mysqli_query($conexion,"SELECT * FROM paciente WHERE Estado_Paciente!='INACTIVO' order by Id_Paciente LIMIT $desde,$x_pag");
    ...
    <th><a href="Modificar_p.php?id=<?php echo $data ["Id_Paciente"];?>" class="button green" name="Modificar" >Modificar</a> 
        <a href="eliminarp.php?id=<?php echo $data ["Id_Paciente"];?>" class="button red" name="Eliminar" >Eliminar</a>
    </th>
